...
public class App extends JFrame {
	...
	private void setBox() {
		page = new EventPage(
				...
				new Dimension( (int) (getWidth()*0.8), (int) (getHeight()*0.65)));
		add(page);
		...
		switchRight.setPreferredSize(new Dimension(70, 90));
		switchLeft.setPreferredSize(new Dimension(30, 90));
		...
		signout.setPreferredSize(new Dimension(50, 90));
		...
		Styling.styleComponent(signout);
		Styling.styleComponent(switchLeft);
		Styling.styleComponent(switchRight);
